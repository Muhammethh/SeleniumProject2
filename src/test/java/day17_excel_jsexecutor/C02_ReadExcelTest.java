...
public class C02_ReadExcelTest extends TestBase {
    ...
    void test01() throws IOException {
        ...
        String userEmail = workbook.getSheet("Sayfa1").getRow(1).getCell(0).toString();
        String userPassword = workbook.getSheet("Sayfa1").getRow(1).getCell(1).toString();

        WebElement emailTextBox = driver.findElement(By.id("formBasicEmail"));
        WebElement passwordTextBox = driver.findElement(By.id("formBasicPassword"));
